...
%% load data
%--------------------------------------------------------------------------
% v2: avoids overwriting of DC in nav kspace + uses first 2TRs as reference
% v3: removes dc sampling points from contrasts 4-6.
...
data_file_path = '/autofs/space/marduk_002/users/shohei/2024_10_07_BCH_mwf_NIST/raw_PulseqScans/XX.dat';
...
for t = 4%1:5
    ...
    %--------------------------------------------------------------------------
    %% look at motion corrupted data after ifft
    %--------------------------------------------------------------------------
    % disp('look at motion corrupted data after ifft');
    % 
    % 
    % Res = zeros(param.N);
    % 
