function [Mz_mtx, Mxy_mtx] = sim_qalas_pd_b1_eff_T2_mwf_dc6(TR, alpha_deg, esp, turbo_factor, t1_vals, t2_vals, num_reps, echo2use, gap_between_readouts, time2relax_at_the_end, b1, inv_eff, pd_map )
%
...
etl_dc6 = (turbo_factor - 8) * esp; % first 8 lines for dc sampling
...
% T2 prep TE 20ms+crusher 9.7ms
delT_M1m_M2m = 29.7e-3;                % duration of T2 prep
delT_M0_M1m = gap_between_readouts - etl - delT_M1m_M2m;

delT_M2m_M3m = etl;                   % duration of readout#0

% T2 prep TE80ms+crusher 9.7ms
delT_M1_M2 = 89.7e-3;                % duration of T2 prep
...
delT_M7_M8 = gap_between_readouts - etl_dc6;          % from end of readout#2 to  begin of readout#3
delT_M8_M9 = etl_dc6;                   % duration of readout#3

% delT_M9_M10 = 900e-3 - etl;         % from end of readout#3 to  begin of readout#4
delT_M9_M10 = gap_between_readouts - etl_dc6;         % from end of readout#3 to  begin of readout#4
delT_M10_M11 = etl_dc6;                 % duration of readout#4

% delT_M11_M12 = 900e-3 - etl;        % from end of readout#4 to  begin of readout#5
delT_M11_M12 = gap_between_readouts - etl_dc6;        % from end of readout#4 to  begin of readout#5
delT_M12_M13 = etl_dc6;                 % duration of readout#5
...
total_event_duration = delT_M0_M1m + delT_M1m_M2m + delT_M2m_M3m + delT_M3m_M1 + delT_M1_M2 + delT_M2_M3 + delT_M3_M4 + delT_M4_M5 + delT_M5_M6 + delT_M6_M7 + delT_M7_M8 + delT_M8_M9 + delT_M9_M10 + delT_M10_M11 + delT_M11_M12 + delT_M12_M13;
...
Mz_mtx = zeross([16, num_voxels, num_reps]);
Mxy_mtx = zeross([6, num_voxels, num_reps]);
...
%     M5 = -M4;
    ...
    Mz_mtx(:,:,reps) = cat(1, M1m.', M2m.', M3m.', M1.', M2.', M3.', M4.', M5.', M6.', M7.', M8.', M9.', M10.', M11.', M12.', M13.');
    Mxy_mtx(:,:,reps) = cat(1, Mxy_acq0(echo2use,:), Mxy_acq1(echo2use,:), Mxy_acq2(echo2use,:), Mxy_acq3(echo2use,:), Mxy_acq4(echo2use,:), Mxy_acq5(echo2use,:));
