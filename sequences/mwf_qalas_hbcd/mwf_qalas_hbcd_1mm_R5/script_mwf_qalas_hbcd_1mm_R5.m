...
path2use = '/autofs/space/marduk_002/users/shohei/mwf_paper/REPOSITORY/sequences/mwf_qalas_hbcd/mwf_qalas_hbcd_1mm_R5/';

% Load ky-kz trajectory data %[kz_position ky_position index]

traj = readmatrix([path2use, 'utils/SeqSmplPattern_CSGRE_228x176_R5_idx_nph6_v2_dc6_v3.csv']); 
