...
path2use = '/autofs/space/marduk_002/users/shohei/mwf_paper/REPOSITORY/sequences/mwf_qalas_adult/mwf_qalas_adult_1mm_R5/';

% Load ky-kz trajectory data %[kz_position ky_position index]

traj = readmatrix([path2use, 'utils/SeqSmplPattern_CSGRE_240x208_R5_idx_nph6_v2_dc6_v3.csv']); 
...
t2prep = readmatrix([path2use, 'utils/T2prep.txt']);
...
text = readmatrix([path2use, 'utils/rf90.txt']);
...
IRprep = readmatrix([path2use, 'utils/invpulse.txt']);
