...
close all; clear; clc;
% addpath(genpath('/PATH_TO_PULSEQ/'))
...
traj            =   readmatrix('utils/fov_240x208_msize_60x52_tl_4_ncal_0_spiral_4_acc_1.5x1.5_nTR284_nph1.txt'); %size(traj) = [kz_position, ky_position, index]
