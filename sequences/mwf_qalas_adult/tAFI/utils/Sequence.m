classdef Sequence < handle
    ...
    methods
        ...
        % See calcPNS_C2.m
        [ok, pns_norm, pns_comp, t_axis]=calcPNS_C2(obj,hardware,doPlots)
...
%             end
        ...
        function f = plot_bw(obj, varargin)
            %plot Plot the sequence in a new figure.
            %   plot(seqObj) Plot the sequence
            %
            %   plot(...,'TimeRange',[start stop]) Plot the sequence
            ...
            for i=1:6
                ...
                % SF: option for black background
                set(ax(i), 'Color', 'k'); % setting the background color to black
                set(gca, 'Color', 'black')
